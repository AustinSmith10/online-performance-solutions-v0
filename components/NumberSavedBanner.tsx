...
const shownKey = (cleanUrl: string) => `number-saved-shown:${cleanUrl}`;
        ...
        <div className="fixed right-4 top-20 z-50 w-80 rounded-xl border border-zinc-200 bg-white p-4 shadow-lg">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-sm font-semibold text-zinc-900">Project number saved</p>
              <p className="mt-0.5 text-xs text-zinc-500">Generate the PBDB from the section highlighted below.</p>
            </div>
            <button
              type="button"
              onClick={dismiss}
