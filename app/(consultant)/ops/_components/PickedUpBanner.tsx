...
export function PickedUpBanner({
  ...
  useEffect(() => {
    ...
    const t2 = setTimeout(() => router.replace(`/ops/projects/${projectId}`, { scroll: false }), 4200);
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/30">
      <div className="mx-4 w-full max-w-sm rounded-xl border border-zinc-200 bg-white p-8 shadow-[0_8px_30px_rgb(0_0_0/0.10)] text-center">
        ...
        <button
          type="button"
          onClick={() => { setVisible(false); router.replace(`/ops/projects/${projectId}`, { scroll: false }); }}
