...
import { addOrgStakeholder, type StakeholderActionState } from "@/app/actions/stakeholders";

export function AddStakeholderForm({ orgId }: { orgId: string }) {
  const boundAdd = addOrgStakeholder.bind(null, orgId);
