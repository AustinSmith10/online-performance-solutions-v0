...
import { updateOrganisation, type OrgFormState } from "@/app/actions/organisations";
import { OrgFormFields } from "@/app/(admin)/admin/organisations/_components/org-form-fields";
import type { Organisation } from "@/types";

export function EditOrgForm({ org }: { org: Organisation }) {
  const boundAction = updateOrganisation.bind(null, org.id);
