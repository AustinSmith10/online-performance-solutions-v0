  ...
  return (
    <div className="space-y-5">
      <form action={formAction} className="space-y-5">
        ...
        <div className="space-y-3 rounded-md border border-zinc-100 bg-zinc-50/60 p-4">
          ...
          <p className="text-xs text-zinc-500">
            Checked on every stakeholder upload into this slot. A soft warning
            only — never blocks the upload.
          </p>
          <div>
            <label className="mb-1 block text-sm font-medium text-zinc-700">
              AI judge hint
      ...
      <ReferenceSampleControl
        ...
        currentSignedUrl={referenceSampleSignedUrl}
        currentFilename={
