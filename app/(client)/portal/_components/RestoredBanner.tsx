...
export function RestoredBanner() {
  ...
  return (
    <div className="modal-backdrop fixed inset-0 z-50 flex items-center justify-center backdrop-blur-sm bg-black/30">
      <div className="modal-panel mx-4 w-full max-w-sm rounded-xl border border-zinc-200 bg-white p-8 shadow-[0_8px_30px_rgb(0_0_0/0.10)] text-center">
        ...
        <p className="text-base font-semibold text-zinc-900">Report request restored</p>
        <p className="mt-2 text-sm text-zinc-500">
          Your report request has been moved back to your project list.
        </p>
        <button
          type="button"
